...
/*Create a trigger that does not let you delete any course semester whose available seats are less than 10.
Print ‘not possible’.
...
declare @temp int;
declare @t2 int;
select @temp=availableseats from deleted;
select @t2=instructorid from deleted;
if(@temp<10)
begin
print 'not poss'
